...
func (s *adminService) RoleUpdate(ctx context.Context, req *apiv1.RoleUpdateRequest) error {
...
func (s *adminService) RoleCreate(ctx context.Context, req *apiv1.RoleCreateRequest) error {
...
func (s *adminService) GetRoles(ctx context.Context, req *apiv1.GetRoleListRequest) (*apiv1.GetRolesResponseData, error) {
	req.Normalize()
